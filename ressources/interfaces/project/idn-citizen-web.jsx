...
function CitizenWeb({ t, screen = "welcome", user = DEMO_USERS.citoyen }) {
  return (
    <BrowserChrome
      t={t}
      url={`https://identite.ga/${screen === "welcome" ? "" : screen}`}
      w={1180}
      h={760}
    >
      <div
  ...
  return (
    ...
    >
      ...
      : <div style={{ display: "flex", gap: 8 }}>
          <IdnButton t={t} variant="quiet" size="sm">
            FR · EN
          </IdnButton>
        ...
        {Array.from({ length: total }).map((_, i) => (
          <div
            ...
            style={{
              ...
              height: 3,
              borderRadius: 2,
              background: i < step ? idnTokens.green : t.border,
            }}
          />
        ))}
      </div>
  ...
  return (
    ...
    >
      <div>
        ...
        >
          Authentifiez-vous une fois sur IDN, accédez à l'ensemble des services
          administratifs gabonais — consulats, ministères, e-Visa, bourses,
          santé.
        </div>
        <div style={{ display: "flex", gap: 10, marginTop: 32 }}>
          <IdnButton
            ...
            variant="primary"
            size="lg"
            leadIcon={IdnIcons.userPlus}
          >
            Créer un compte IDN
          </IdnButton>
          <IdnButton t={t} variant="ghost" size="lg" leadIcon={IdnIcons.login}>
            Se connecter
          </IdnButton>
        </div>
      </div>
        ...
        {[
          {
            l: 1,
            n: "Faible",
            d: "Email vérifié — services informatifs, e-Visa",
            col: t.muted,
          },
          {
            l: 2,
            n: "Substantiel",
            d: "Document + selfie liveness — résidents",
            col: idnTokens.blue,
          },
          {
            l: 3,
            n: "Élevé",
            d: "KYC vidéo + état civil — services régaliens",
            col: idnTokens.green,
          },
        ].map((r, i, arr) => (
          <div
...
function CWSignup({ t }) {
  return (
    <CWWizard
      ...
      sub="Email et mot de passe — vous pourrez ajouter une 2FA plus tard."
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <IdnInput
          ...
          hint="Minimum 8 caractères, mélangez chiffres et symboles."
        />
        <label
          style={{
            display: "flex",
    ...
    <CWWizard
      ...
      sub={
        <>
          ...
          <b style={{ color: t.ink }}>aissatou.mboumba@example.ga</b>
        </>
      }
      primary="Vérifier"
    >
...
function CWPin({ t }) {
  return (
    <CWWizard
      ...
      sub="Un code à 6 chiffres pour les actions sensibles : signature, validation, accès rapide mobile."
      primary="Confirmer"
    >
      <div
        style={{
        ...
        {[1, 1, 1, 1, 0, 0].map((v, i) => (
          <div
            ...
            style={{
              ...
              height: 18,
              borderRadius: 9999,
              background: v ? idnTokens.green : "transparent",
              border: `2px solid ${v ? idnTokens.green : t.border}`,
            }}
          />
        ))}
      </div>
      ...
      >
        ...
        Évitez les suites évidentes (123456) ou répétées (000000). Vous pourrez
        le changer dans <b>Mon profil → Sécurité</b>.
      </div>
    </CWWizard>
  );
}
...
function CWLogin({ t }) {
  return (
    <div style={{ maxWidth: 420, margin: "80px auto", padding: "0 24px" }}>
      ...
      >
        à votre compte Identité Numérique
      </div>
      <div
        style={{
          display: "flex",
      ...
      <IdnButton t={t} variant="ghost" size="md" full leadIcon={IdnIcons.qr}>
      ...
      >
        ...
        <span
          style={{ color: idnTokens.green, fontWeight: 500, cursor: "pointer" }}
        >
          Créer un compte IDN
        </span>
      </div>
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              ...
              <span style={{ fontSize: 12, color: t.muted }}>
                · ID IDN{" "}
                <span style={{ fontFamily: idnTokens.mono, color: t.ink2 }}>
                  GA-7K3J-9Q2L
                </span>
              </span>
            </div>
        ...
        {user.loa < 3 ?
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                Passez au Niveau {user.loa + 1} pour débloquer plus de services
                administratifs.
              </div>
              <IdnButton
                t={t}
        ...
        {[
          {
            ...
            m: "depuis Libreville · iPhone",
          },
          {
            ts: "Hier 09:14",
            e: "Niveau de garantie élevé au 3",
            m: "KYC vidéo validé",
          },
          {
            ts: "06 mai",
          ...
          >
            ...
            <span
              style={{ fontSize: 13, color: t.ink, fontWeight: 500, flex: 1 }}
            >
              {r.e}
            </span>
...
function CWProfile({ t, user }) {
  const Row = ({ label, value, mono }) => (
    ...
    >
      <span
        style={{ fontSize: 12, color: t.muted, width: 200, letterSpacing: 0.4 }}
      >
        {label}
      </span>
      <span
...
function CWConsents({ t }) {
  const apps = [
    ...
    },
    {
      ...
      desc: "Min. de l'Enseignement supérieur",
      scopes: ["profile", "birth_cert", "loa:3"],
      date: "04 fév 2026",
    },
    {
      name: "Santé.ga",
  ...
  return (
    <div style={{ maxWidth: 880, margin: "0 auto", padding: "32px 28px" }}>
      ...
      <div style={{ fontSize: 14, color: t.muted, marginTop: 8 }}>
        {apps.length} applications ont accès à vos données IDN. Révocable à tout
        moment.
      </div>
      <div
        style={{
...
function CWKyc({ t }) {
  return (
    <div style={{ maxWidth: 880, margin: "0 auto", padding: "32px 28px" }}>
      ...
      >
        VÉRIFICATION D'IDENTITÉ · NIVEAU 2
      </div>
      <div
        style={{
          fontSize: 28,
      ...
      >
        Trois étapes pour passer du Niveau 1 (email vérifié) au Niveau 2
        (substantiel). Comptez environ 5 minutes.
      </div>
      <div
        style={{
          display: "grid",
      ...
      >
        {[
          {
            n: "01",
            t: "Document d'identité",
            d: "Photographiez votre CNI gabonaise recto-verso. Cadrage automatique.",
            icon: IdnIcons.doc,
            status: "à faire",
          },
          {
            n: "02",
            t: "Selfie vivant",
            d: "Détection de présence + face match avec le document.",
            icon: IdnIcons.camera,
            status: "à faire",
          },
          {
            n: "03",
            t: "Validation",
            d: "Revue automatique puis manuelle si nécessaire (24-48h).",
            icon: IdnIcons.check,
            status: "à faire",
          },
        ].map((s, i) => (
      ...
      >
        ...
        <div style={{ flex: 1, fontSize: 12, color: t.ink2, lineHeight: 1.5 }}>
          Le KYC peut s'effectuer plus confortablement depuis l'app mobile
          (caméra). Voulez-vous y continuer ?
        </div>
        <IdnButton t={t} variant="ghost" size="sm" leadIcon={IdnIcons.qr}>
          Continuer sur mobile
        </IdnButton>
      </div>
      <div style={{ marginTop: 20 }}>
        <IdnButton t={t} variant="primary" size="lg" leadIcon={IdnIcons.camera}>
          Démarrer ici
        </IdnButton>
      </div>
    </div>
...
function CWKycStatus({ t }) {
  return (
    ...
    >
      ...
      <div
        style={{ fontSize: 14, color: t.muted, marginTop: 10, lineHeight: 1.6 }}
      >
        Votre dossier passe en revue automatique puis manuelle si nécessaire.
        <br />
        Vous serez notifié·e sous 24-48h par email.
      </div>
      <div
        style={{
          marginTop: 28,
