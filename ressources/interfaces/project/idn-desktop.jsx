    ...
    <div
      style={{
        ...
        boxShadow:
          ...
          : "0 24px 60px rgba(40,50,30,0.12)",
        display: "flex",
...
function OidcDesktop({ t }) {
  return (
    <BrowserChrome
      t={t}
      url="https://identite.ga/oauth/authorize?client_id=consulat-ga&..."
    >
      <div
        style={{
          height: "100%",
      ...
      >
        ...
        >
          ...
          >
            Connexion à{" "}
            <span style={{ color: idnTokens.green }}>Consulat.ga</span>
          </div>
          <div
            style={{
              textAlign: "center",
          ...
          >
            connecté en tant qu'
            <b style={{ color: t.ink, fontWeight: 500 }}>Aïssatou Mboumba</b>
          </div>
          <div
            style={{
              marginTop: 24,
          ...
          >
            {[
              {
                l: "Identité pivot",
                s: "nom, prénom, date de naissance, lieu de naissance",
              },
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 22 }}>
            ...
            <IdnButton t={t} variant="primary" size="lg" style={{ flex: 1 }}>
              Autoriser
            </IdnButton>
          </div>
          <div
        ...
        >
          {nav.map((n) => {
            ...
            return (
              ...
              >
                <span style={{ display: "flex", opacity: sel ? 1 : 0.7 }}>
                  {n.icon}
                </span>
                {n.label}
                {n.tag && (
...
function AdminConsole({ t, initialTab = "dashboard" }) {
  ...
  return (
    <BrowserChrome t={t} url="https://admin.identite.ga/" w={1180} h={760}>
      <OpShell
        t={t}
        title="Admin · Système"
        role="ADMINISTRATEUR"
  ...
  return (
    ...
    >
      ...
      >
        {delta && (
          <span
            style={{ fontSize: 12, color: idnTokens.green, fontWeight: 500 }}
          >
            {delta}
          </span>
        )}
...
function AdminDashboard({ t }) {
  ...
  const loa = [
    { l: "Niveau 1", v: 38, c: t.muted },
    { l: "Niveau 2", v: 28, c: idnTokens.blue },
    { l: "Niveau 3", v: 34, c: idnTokens.green },
  ];
  return (
    <>
      <OpHeader
      ...
      <div style={{ flex: 1, overflow: "auto", padding: 28 }}>
              ...
              {bars.map((v, i) => (
                <div
                  ...
                  style={{
                    ...
                    height: `${v}%`,
                    background:
                      i === bars.length - 1 ? idnTokens.green
                      : t.dark ? "#1F4A2E"
                      : "#B8DCC4",
        ...
        >
          ...
          {[
            {
              t: "14:32",
              e: "Application enregistrée",
              d: "Bourses Étudiantes — en attente de revue",
              tag: "apps",
            },
            {
              t: "13:48",
              e: "KYC approuvé",
              d: "M. Lefèvre → Niveau 2",
              tag: "kyc",
            },
            {
              t: "12:11",
              e: "Échec OTP répété",
              d: "+241 6X XX XX 12 — 5 tentatives",
              tag: "security",
            },
            {
              t: "10:22",
              e: "Provider email switché",
              d: "Resend → AWS SES (admin)",
              tag: "config",
            },
          ].map((r, i, arr) => (
            <div
...
function AdminApps({ t }) {
  ...
  const statusColor = {
    production: idnTokens.green,
    pending: idnTokens.yellow,
    sandbox: t.muted,
  };
  return (
    <>
      ...
      <div style={{ flex: 1, overflow: "auto", padding: 28 }}>
        ...
        >
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "1.6fr 1.4fr 1fr 0.8fr 0.8fr 40px",
              padding: "12px 18px",
              background: t.surface2,
              fontSize: 11,
              color: t.muted,
          ...
          {apps.map((a, i) => (
            <div
              ...
              style={{
                ...
                color: t.ink,
                borderBottom:
                  i === apps.length - 1 ? "none" : `1px solid ${t.borderSoft}`,
              }}
            >
              ...
              <div style={{ color: t.muted, cursor: "pointer" }}>
                {IdnIcons.more}
              </div>
            </div>
          ))}
      ...
      <OpHeader
        ...
        right={
          <IdnButton
            ...
            size="sm"
            leadIcon={IdnIcons.search}
            style={{ width: 220, justifyContent: "flex-start", color: t.muted }}
          >
            Email, ID IDN, nom…
          </IdnButton>
        }
      ...
      <div style={{ flex: 1, overflow: "auto", padding: 28 }}>
        ...
        >
          <div
            style={{
              display: "grid",
              gridTemplateColumns: "2fr 2fr 1fr 1fr 1fr 60px",
              padding: "12px 18px",
              background: t.surface2,
              fontSize: 11,
              color: t.muted,
          ...
          {users.map((u, i) => (
            <div
              ...
              style={{
                ...
                color: t.ink,
                borderBottom:
                  i === users.length - 1 ? "none" : `1px solid ${t.borderSoft}`,
              }}
            >
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <div
              ...
              <div>
                <LoABadge level={u.loa} t={t} compact />
              </div>
  ...
  const logs = [
    {
      ...
      level: "info",
      evt: "auth.success",
      user: "aissatou.m@example.ga",
      meta: "consulat-ga · ip 41.158.x.x",
    },
    {
      ts: "14:31:55",
      level: "info",
      evt: "token.issued",
      user: "aissatou.m@example.ga",
      meta: "access · refresh · jti=7K3..",
    },
    {
      ts: "14:30:12",
      level: "warn",
      evt: "otp.fail",
      user: "+241 6X XX XX 12",
      meta: "attempt 3/5",
    },
    {
      ts: "14:29:44",
      level: "info",
      evt: "kyc.approved",
      user: "marc.lefevre@example.fr",
      meta: "L1 → L2 · controller@identite.ga",
    },
    {
      ts: "14:28:01",
      level: "info",
      evt: "consent.granted",
      user: "jb.ondo@example.ga",
      meta: "sante-ga · scopes: profile,loa:3",
    },
    {
      ts: "14:27:33",
      level: "error",
      evt: "auth.fail",
      user: "—",
      meta: "invalid_client · cnamgs-portal",
    },
    {
      ts: "14:26:50",
      level: "info",
      evt: "session.revoked",
      user: "sarah.c@example.com",
      meta: "by user · 1 device",
    },
    {
      ts: "14:25:17",
      level: "info",
      evt: "app.created",
      user: "admin@identite.ga",
      meta: "bourses-min-edu · pending",
    },
  ];
        ...
        >
          {logs.map((l, i) => (
            <div
              ...
              style={{
                display: "grid",
                gridTemplateColumns: "90px 60px 1.2fr 1.6fr 2fr",
                gap: 12,
                padding: "10px 18px",
                alignItems: "center",
                borderBottom:
                  i === logs.length - 1 ? "none" : `1px solid ${t.borderSoft}`,
              }}
            >
  ...
  return (
    <>
      <OpHeader
        ...
        right={
          <IdnButton t={t} variant="primary" size="sm" leadIcon={IdnIcons.plus}>
            Nouveau rôle
          </IdnButton>
        }
      />
        ...
        return (
          <div
            ...
            style={{
              ...
              padding: "12px 14px",
              borderRadius: 10,
              border: `1.5px solid ${sel ? idnTokens.green : t.borderSoft}`,
              background:
                sel ?
                  t.dark ?
                    "#0F2A18"
  ...
  return (
    <>
      ...
      <div style={{ flex: 1, padding: 28, overflow: "auto", maxWidth: 820 }}>
        <Section
          title="Email — un provider actif"
          active="resend"
          providers={[
            {
              id: "resend",
              name: "Resend",
              desc: "Provider par défaut MVP · 38.4k envois / mois",
            },
            {
              id: "sendgrid",
              name: "SendGrid",
              desc: "Twilio · clé API configurée",
            },
            {
              id: "aws-ses",
              name: "AWS SES",
              desc: "Région eu-west-3 · vérification DKIM ok",
            },
            {
              id: "smtp",
              name: "SMTP custom",
              desc: "Pour relais on-premise gabonais",
            },
          ]}
        />
        <Section
          title="SMS — Phase 2 (non actif)"
          providers={[
            {
              id: "twilio",
              name: "Twilio",
              desc: "Couverture mondiale · sandbox configuré",
            },
            { id: "vonage", name: "Vonage", desc: "Anciennement Nexmo" },
            {
              id: "africastalking",
              name: "Africa's Talking",
              desc: "Recommandé pour le Gabon · prix local",
            },
          ]}
        />
      </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          >
            ...
            <CredRow
              t={t}
              label="REDIRECT URIS"
              value="https://bourses.education.ga/auth/callback"
            />
            <CredRow
              t={t}
              label="SCOPES"
              value="profile, email, birth_cert, loa:3"
            />
            <CredRow t={t} label="NIVEAU MIN." value="3 — Élevé" />
            <CredRow
              t={t}
              label="CONSENT"
              value="non-trusted (écran de consentement requis)"
            />
          </div>
          <div
            style={{
          ...
          >
            ...
            >
              {[40, 56, 48, 62, 70, 65, 78, 82, 75, 88, 92, 85, 96, 100].map(
                (v, i) => (
                  <div
                    key={i}
                    style={{
                      flex: 1,
                      height: `${v}%`,
                      background: t.dark ? "#1F4A2E" : "#B8DCC4",
                      borderRadius: "3px 3px 0 0",
                    }}
                  />
                ),
          ...
          {[
            {
              ...
              e: "Demande de passage en production",
              a: "dev@startup.ga",
            },
            { ts: "08 mai · 09:14", e: "Secret régénéré", a: "dev@startup.ga" },
            {
              ts: "02 mai · 16:00",
              e: "Scope birth_cert ajouté",
              a: "dev@startup.ga",
            },
            {
              ts: "14 avr · 11:20",
...
function ControllerConsole({ t, initialTab = "queue" }) {
  ...
  return (
    <BrowserChrome t={t} url="https://controller.identite.ga/" w={1180} h={760}>
      <OpShell
        t={t}
        title="Agent K. Ovono"
    ...
    <>
      ...
      <div style={{ flex: 1, overflow: "auto", padding: 28 }}>
          ...
          {queue.map((q, i) => (
            <div
              ...
              style={{
                padding: "16px 20px",
                borderBottom:
                  i === queue.length - 1 ? "none" : `1px solid ${t.borderSoft}`,
                display: "flex",
                alignItems: "center",
                gap: 18,
              }}
              ...
              {q.priority === "haute" && (
                <span
                  style={{
                    ...
                    padding: "3px 8px",
                    borderRadius: 9999,
                    background: t.dark ? "#3A1E1E" : "#FBE5E5",
                    color: "#B83A3A",
                    letterSpacing: 0.5,
                  }}
                >
        ...
        >
          ...
          >
            Cas en cours d'examen — KYC-7K9-3F2
          </div>
          <div
            style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}
          >
            <div
              style={{
                aspectRatio: "1.6 / 1",
                borderRadius: 10,
                background: `repeating-linear-gradient(45deg, ${t.surface2}, ${t.surface2} 8px, ${t.dark ? "#2A2F26" : "#E8E5DC"} 8px, ${t.dark ? "#2A2F26" : "#E8E5DC"} 16px)`,
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                fontFamily: idnTokens.mono,
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 14 }}>
            <IdnButton t={t} variant="primary" size="md">
              Approuver
            </IdnButton>
            <IdnButton t={t} variant="ghost" size="md">
              Demander un complément
            </IdnButton>
            <div style={{ flex: 1 }} />
            <IdnButton t={t} variant="danger" size="md">
              Rejeter
            </IdnButton>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 12, color: t.muted, marginTop: 4 }}>
            Demandez au titulaire de présenter son code IDN.
          </div>
          <div
            style={{
              flex: 1,
          ...
          >
            <div
              style={{
                width: 200,
                height: 200,
                border: `2px solid ${idnTokens.green}`,
                borderRadius: 12,
                position: "relative",
              }}
            >
              <div
                style={{
                  ...
                  background: idnTokens.green,
                  opacity: 0.7,
                  boxShadow: `0 0 10px ${idnTokens.green}`,
                }}
              />
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: t.muted, marginTop: 2 }}>
                14 mars 1992 · Libreville
              </div>
              <div style={{ marginTop: 6 }}>
                <LoABadge level={3} t={t} compact />
              </div>
            </div>
          </div>
          <div
          ...
          >
            <span style={{ color: idnTokens.green, marginTop: 1 }}>
              {IdnIcons.check}
            </span>
            <div>
              <div style={{ fontSize: 13, fontWeight: 600, color: t.ink }}>
              ...
              >
                JWT signé · clé jwks-2026-04 · expire 14:42
              </div>
            </div>
          </div>
          <div
          ...
          >
            <span style={{ color: "#A7841C", marginTop: 1 }}>
              {IdnIcons.bell}
            </span>
            Le titulaire sera notifié de ce contrôle (transparence).
          </div>
          <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
            <IdnButton t={t} variant="primary" size="md" full>
              Valider le contrôle
            </IdnButton>
            <IdnButton t={t} variant="ghost" size="md">
              Annuler
    ...
    <>
      ...
      <div style={{ flex: 1, padding: 28 }}>
        ...
        >
          ...
          <textarea
            readOnly
            defaultValue="eyJhbGciOiJSUzI1NiIsImtpZCI6Imp3a3MtMjAyNi0wNCJ9.eyJzdWIiOiJHQS03SzNKLTlRMkwiLCJpc3MiOiJodHRwczovL2lkbi5nYSIsIm5hbWUiOiJBw69zc2F0b3UgTWJvdW1iYSIsImxvYSI6MywiaWF0IjoxNzQ2OTAyNTAwLCJleHAiOjE3NDY5MDYxMDB9.MEUCIQDh..."
            style={{
              width: "100%",
              height: 100,
              marginTop: 10,
          ...
          {hist.map((h, i) => (
            <div
              ...
              style={{
                ...
                gap: 14,
                borderBottom:
                  i === hist.length - 1 ? "none" : `1px solid ${t.borderSoft}`,
              }}
            >
              <span
                style={{
              ...
              <span
                style={{ fontSize: 13, fontWeight: 500, color: t.ink, flex: 1 }}
              >
                {h.name}
              </span>
              <span style={{ fontSize: 12, color: t.muted, flex: 1 }}>
...
function DevPortal({ t, initialTab = "apps" }) {
  ...
  return (
    <BrowserChrome t={t} url="https://developers.identite.ga/" w={1180} h={760}>
      <OpShell
        t={t}
        title="dev@startup.ga"
        role="DÉVELOPPEUR"
        badge="D"
        nav={nav}
        active={tab}
...
function DevApps({ t }) {
  const apps = [
    ...
    {
      name: "Bourses Étudiantes — Sandbox",
      env: "sandbox",
      loa: 3,
      scopes: ["profile", "email", "birth_cert", "loa:3"],
      reqs: "142 / mois",
                    ...
                    <span
                      style={{
                        ...
                        background:
                          ...
                          : t.surface2,
                        color:
                          a.env === "production" ? idnTokens.green : t.muted,
                      }}
                    >
                      {a.env.toUpperCase()}
                    </span>
  ...
  return (
    <>
      ...
      <div style={{ flex: 1, padding: 28, overflow: "auto" }}>
        ...
        >
          <CredRow t={t} label="ISSUER" value="https://identite.ga" />
          <CredRow
            t={t}
            label="DISCOVERY"
            value="https://identite.ga/.well-known/openid-configuration"
          />
          <CredRow t={t} label="CLIENT_ID" value="bourses-min-edu" />
          <CredRow
            t={t}
            label="CLIENT_SECRET"
            value="idn_sk_3F92x7Kp9Lq2WnRfGv8sZmTcUe1AhJ..."
            secret
          />
          <CredRow
            t={t}
          ...
          <CredRow
            t={t}
            label="JWKS"
            value="https://identite.ga/.well-known/jwks.json"
          />
        </div>
        ...
        >
          Intégration en 3 lignes (Better Auth)
        </div>
        <pre
          style={{
            background: t.dark ? "#0E110D" : "#16170F",
            color: "#E6F2EA",
            padding: 20,
            borderRadius: 12,
            fontFamily: idnTokens.mono,
...
function DevDocs({ t }) {
  const sections = [
    ...
    {
      t: "@idn/better-auth",
      items: ["Helper idn()", "Mapping de profil", "genericOAuth config"],
    },
    {
      t: "@idn/core",
      items: ["createIDNClient()", "signIn / signOut", "handleCallback"],
    },
    { t: "@idn/react", items: ["<IDNProvider>", "useUser()", "useSession()"] },
    {
      t: "OIDC standard",
      items: ["Discovery", "Authorization Code + PKCE", "JWKS & rotation"],
    },
  ];
  return (
    <>
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, overflow: "auto", padding: "24px 32px" }}>
          ...
          >
            ...
            dans Better Auth. Auto-configure le discovery, les scopes par
            défaut, PKCE et le mapping du profil.
          </div>
          <pre
            style={{
              background: t.dark ? "#0E110D" : "#16170F",
...
await authClient.signIn.oauth2({ providerId: "idn" });`}</pre>
          ...
          >
            <span style={{ color: idnTokens.blue, marginTop: 1 }}>
              {IdnIcons.shield}
            </span>
            <span>
              Pour exiger un niveau de garantie minimum, ajouter{" "}
              <code style={{ fontFamily: idnTokens.mono, fontSize: 11 }}>
...
function DevUsage({ t }) {
  const bars = [
    42, 38, 50, 48, 62, 70, 65, 78, 82, 88, 75, 92, 98, 90, 100, 95, 88,
  ];
  return (
    <>
      ...
      <div style={{ flex: 1, padding: 28, overflow: "auto" }}>
        ...
        >
          ...
          <Stat
            ...
            label="LATENCE P95"
            value="142ms"
            hint="seuil SLA : 300ms"
          />
          <Stat
            t={t}
            label="ERREURS 4XX"
            value="0.42%"
            hint="invalid_grant principalement"
          />
        </div>
        <div
          style={{
