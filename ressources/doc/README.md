...
| [ADR-0010](./adr-0010-multi-apps-auth-cross-domain.md) | Auth multi-apps : `crossDomain` + checks 100 % client | Remplacé par ADR-0012 |
| [ADR-0011](./adr-0011-deploiement-gcp-cloud-run.md) | Déploiement Phase 1 sur GCP Cloud Run (remplace Vercel §12.2) | Accepté |
| [ADR-0012](./adr-0012-fusion-connect-identite-ga.md) | Fusion de `connect.identite.ga` dans `identite.ga` | Accepté |
