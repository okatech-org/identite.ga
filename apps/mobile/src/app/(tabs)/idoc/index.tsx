        ...
        right={
          <View style={{ flexDirection: 'row', gap: 6 }}>
            ...
            >
              ...
              <View style={{ position: 'absolute', top: 6, right: 7, width: 7, height: 7, borderRadius: 9999, backgroundColor: '#B83A3A' }} />
            </Pressable>
          </View>
        }
      />
        ...
        <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 10 }}>
          {DOC_FOLDERS.map((f, i) => (
            <View key={f.id} style={{ width: '48.5%' }}>
              <FolderCard f={f} t={t} opened={i === 0} onPress={() => router.push(`/idoc/folder/${f.id}` as any)} />
            </View>
          ))}
        </View>
      </ScrollView>
