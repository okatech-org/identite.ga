    ...
    <View style={{ flex: 1, backgroundColor: t.bg, paddingTop: insets.top }}>
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 22, paddingTop: 4, paddingBottom: 22 }}>
        <View style={{
          ...
          <Text style={{ fontSize: 12, color: t.muted, marginTop: 4 }}>République Gabonaise · ANINF</Text>
          <Text style={{ fontFamily: idnTokens.mono, fontSize: 11, color: t.muted, marginTop: 14 }}>v1.2.0 · MVP · build 2026.05.11</Text>
        </View>
        ...
        <View style={{ backgroundColor: t.surface, borderWidth: 1, borderColor: t.border, borderRadius: 14, overflow: 'hidden' }}>
          <SetMobileRow t={t} label="Conditions d'utilisation" />
          <SetMobileRow t={t} label="Politique de confidentialité" />
          <SetMobileRow t={t} label="Mentions légales" />
          <SetMobileRow t={t} label="Accessibilité (RGAA)" />
          <SetMobileRow t={t} label="Licences open source" />
        </View>
