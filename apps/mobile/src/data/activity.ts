...
export const ACTIVITY_FILTERS = ['Tout', 'Connexions', 'Consentements', 'KYC', 'Sécurité'] as const;
...
export const ACTIVITY_GROUPS: { d: string; items: ActivityItem[] }[] = [
  ...
  { d: '06 mai', items: [
    ...
    { ts: '08:14', cat: 'NOTIF', e: 'Email de bienvenue lu', m: 'Premier message IDN', col: '#74766B' },
  ]},
];
