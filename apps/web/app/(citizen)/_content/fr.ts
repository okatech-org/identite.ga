...
export const profile = {
  ...
  pivot: {
    ...
    rows: {
      ...
      phoneUnverified: "À vérifier",
      idnId: "ID IDN",
      nip: "NIP (RBPP)",
      nipEmpty: "Non renseigné",
    },
  },
  security: {
    eyebrow: "SÉCURITÉ",
...
export const settings = {
  ...
  security: {
    ...
    nip: {
      title: "NIP (Numéro d'Identification Personnel)",
      subConfigured: "Configuré. Identifiant RBPP à 14 caractères.",
      subNotConfigured: "Non renseigné. Ajoutez votre NIP délivré par le RBPP.",
      cta: "Modifier",
      ctaDefine: "Ajouter",
      modalTitle: "Modifier le NIP",
      label: "NIP",
      hint: "14 caractères alphanumériques, tel qu'il figure sur votre document RBPP.",
      submit: "Enregistrer",
      cancel: "Annuler",
      successToast: "NIP mis à jour.",
      validationError: "Le NIP doit contenir exactement 14 caractères (lettres ou chiffres).",
    },
    twoFactor: {
...
export const profileEdit = {
  ...
  fields: {
    ...
    phone: {
      ...
      hint: "Numéro gabonais ou français. Utilisez de préférence le format international (+241 ou +33).",
      verified: "Numéro vérifié par SMS",
      unverified: "Ce numéro historique n'a pas encore été vérifié.",
      empty: "Aucun numéro n'est encore associé à ce compte.",
      send: "Envoyer le code",
      sending: "Envoi…",
      codeLabel: "Code reçu par SMS",
      codeSub: (maskedPhone: string) =>
        `Saisissez le code à 6 chiffres envoyé au ${maskedPhone}.`,
      verify: "Valider le numéro",
      verifying: "Vérification…",
      restart: "Modifier le numéro",
      success: "Numéro de téléphone vérifié et enregistré.",
      invalidCode: "Code incorrect ou expiré.",
      error: "Impossible de vérifier ce numéro pour le moment.",
    },
  },
  primary: "Enregistrer",
  cancel: "Annuler",
